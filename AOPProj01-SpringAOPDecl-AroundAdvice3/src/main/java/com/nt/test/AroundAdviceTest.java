...
public class AroundAdviceTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("proxy object classname::"+proxy.getClass()+"  super class"+proxy.getClass().getSuperclass()+"method names"+Arrays.deepToString(proxy.getClass().getDeclaredMethods()));
		try {
